...
public class C01_WindowHandle {
    ...
    public void handleWindows() throws InterruptedException {
        ...
        System.out.println("ilk sayfqanin window handle degeri : " + driver.getWindowHandle());
        ...
        //facebook'un acik oldugu sayfaya gecin ve
        ...
        //1. ve 2. sayfanin window degerlerini biliyoruz
        ...
        System.out.println("windowHandleDegeri3 = " + windowHandleDegeri3);
