...
import org.openqa.selenium.devtools.v96.overlay.model.IsolatedElementHighlightConfig;
...
public class C03_Dropdown {
    ...
    public void dropdownTesti() {
        ...
        https:
//the-internet.herokuapp.com/dropdown adresine gidin.
        driver.get("https://the-internet.herokuapp.com/dropdown");
        WebElement dropdownElementi = driver.findElement(By.xpath("//select[@id='dropdown']"));

        Select option = new Select(dropdownElementi);
